...
Для обучения OCR-aware модели OCR был рассчитан для всего датасета.

Воспроизводимый ноутбук, которым делался OCR:

```text
notebooks/ocr_all_data.ipynb
```
...
Оставшиеся изображения были распознаны через более быстрый PaddleOCR backend:
