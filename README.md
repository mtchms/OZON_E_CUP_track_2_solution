...
Два значения score, приведённые ниже, относятся **к Public Leaderboard**, информации о том, какое из решений какой score дало на private leaderbord не предоставлено.
...
![Public LB 0,9024064171122994](assets/public_lb_0.9024064171.png)
...
Проверка того, что все артефакты целы и их SHA256 совпадает с отправленными.
...
```text
Private Leaderboard: 2-е место (score = 0.8717948718)
```
